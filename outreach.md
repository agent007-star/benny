...
### Landing Pages:
- **安装引导页**: https://0x0.st/P9Cq.html
- **完整 Landing Page**: https://0x0.st/P9CP.html
- **Tarball 直链**: https://0x0.st/P9CK.0.tgz
...
curl -sL https://0x0.st/P9CZ.sh | bash
```
或：`npm install https://0x0.st/P9CK.0.tgz -g`
...
开源地址：https://github.com/benny-co/benny
```
...
### Live Install Links:
- **一键安装脚本**: https://0x0.st/P9CZ.sh
- **Tarball 直链**: https://0x0.st/P9CK.0.tgz (59KB)
- **安装引导页**: https://0x0.st/P9Cq.html
- **完整 Landing Page**: https://0x0.st/P9CP.html
