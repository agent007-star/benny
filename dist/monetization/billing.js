...
import { PLANS, formatPlan } from "./plans.js";
import { getMonthlyUsage, getCurrentPlan, setPlan, resetBillingCycle, } from "./usage-tracker.js";
...
export function formatUpgradeOptions(currentTier) {
    const lines = [];
    lines.push(chalk.bold("\n=== Benny 升级计划 ===\n"));
...
export async function activatePlan(tierArg) {
    const tierMap = {
...
export function openUpgradeLink(tier) {
